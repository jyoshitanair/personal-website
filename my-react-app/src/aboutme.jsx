...
export default function aboutme() {
    ...
    <div>
        ...
        <div className = "button_holder">
            ...
            <button style = {{fontSize: `${buttonA? "larger": "3cqw"}`, textAlign: `${buttonA ? "center": "left"}` }} className = "button_img" onClick = {() => setButtonSideA(!buttonA)}> {buttonA? "Tech!" : "I use Godot, React, Arduino, and Supabase! also! I'm member of Hack Club! Check out my"} {buttonA? "": <a href = "">Projects Page!</a>} {!buttonA? "": <img src = {art}/>} </button>
        </div>
        <h2> Helloo ~ </h2>
